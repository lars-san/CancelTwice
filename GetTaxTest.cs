namespace AvaTaxCalcSOAP
{
    ...
    public class GetTaxTest
    {
        ...
        {
            string accountNumber = "1100001249";//"larswhite";//"1100001249";//ConfigurationManager.AppSettings["AvaTax:AccountNumber"];
            string licenseKey = "53A1E773EF48EF2E";//"G0.AvaTax";//"53A1E773EF48EF2E";//ConfigurationManager.AppSettings["AvaTax:LicenseKey"];
            string serviceURL = "https://avatax.avalara.net";// ConfigurationManager.AppSettings["AvaTax:ServiceUrl"];
            ...
            getTaxRequest.CompanyCode = "Lars";
            getTaxRequest.DocCode = "INV001erfgn";
